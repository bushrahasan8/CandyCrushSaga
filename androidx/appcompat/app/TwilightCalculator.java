...
class TwilightCalculator {
    ...
    public void calculateTwilight(long j, double d, double d2) {
        ...
        double sin = (Math.sin(d3) * 0.03341960161924362d) + d3 + (Math.sin(2.0f * r0) * 3.4906598739326E-4d) + (Math.sin(r0 * 3.0f) * 5.236000106378924E-6d) + 1.796593063d + 3.141592653589793d;
        double round = ((float) Math.round((r0 - 9.0E-4f) - r0)) + 9.0E-4f + ((-d2) / 360.0d) + (Math.sin(d3) * 0.0053d) + (Math.sin(2.0d * sin) * (-0.0069d));
