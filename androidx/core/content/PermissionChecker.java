...
/* loaded from: PermissionChecker.class */
public abstract class PermissionChecker {
    ...
    public static int checkPermission(Context context, String str, int i, int i2, String str2) {
        ...
        return ((Process.myUid() != i2 || !ObjectsCompat.equals(context.getPackageName(), str3)) ? AppOpsManagerCompat.noteProxyOpNoThrow(context, permissionToOp, str3) : AppOpsManagerCompat.checkOrNoteProxyOp(context, i2, permissionToOp, str3)) == 0 ? 0 : -2;
    }
