...
public final class LocalBroadcastManager {
    ...
    /* loaded from: LocalBroadcastManager$1.class */
    public class AnonymousClass1 extends Handler {
        final LocalBroadcastManager this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(LocalBroadcastManager localBroadcastManager, Looper looper) {
            super(looper);
    ...
    private LocalBroadcastManager(Context context) {
        ...
        this.mHandler = new Handler(this, context.getMainLooper()) { // from class: androidx.localbroadcastmanager.content.LocalBroadcastManager.1
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            AnonymousClass1(LocalBroadcastManager this, Looper looper) {
                super(looper);
                this.this$0 = this;
            }
                ...
                for (int i = 0; i < arrayList.size(); i++) {
                    ...
                    if (!receiverRecord.broadcasting) {
                        ...
                        if (match >= 0) {
                            ...
                            Log.v(TAG, "  Filter did not match: " + (match != -4 ? match != -3 ? match != -2 ? match != -1 ? "unknown reason" : "type" : "data" : t2.h.h : "category"));
                        }
                    } else if (z) {
