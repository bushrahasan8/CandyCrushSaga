...
public class InterstitialAd implements FullScreenAd {
    ...
    @Keep
    /* loaded from: InterstitialAd$InterstitialAdLoadConfigBuilder.class */
    public interface InterstitialAdLoadConfigBuilder extends Ad.LoadConfigBuilder {

        /* loaded from: InterstitialAd$InterstitialAdLoadConfigBuilder$_CC.class */
    ...
    @Keep
    /* loaded from: InterstitialAd$InterstitialAdShowConfigBuilder.class */
    public interface InterstitialAdShowConfigBuilder extends FullScreenAd.ShowConfigBuilder {

        /* loaded from: InterstitialAd$InterstitialAdShowConfigBuilder$_CC.class */
        public abstract /* synthetic */ class _CC {
        }
    ...
    @Keep
    /* loaded from: InterstitialAd$InterstitialLoadAdConfig.class */
    public interface InterstitialLoadAdConfig extends Ad.LoadAdConfig {
    }

    @Keep
    /* loaded from: InterstitialAd$InterstitialShowAdConfig.class */
