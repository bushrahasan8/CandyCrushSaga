...
@Keep
/* loaded from: AdComponentFrameLayout.class */
public abstract class AdComponentFrameLayout extends FrameLayout implements AdComponentView {
    ...
    public AdComponentFrameLayout(Context context) {
        super(context);
        this.mAdComponentViewParentApi = new AdComponentViewParentApi(this) { // from class: com.facebook.ads.internal.api.AdComponentFrameLayout.1
            final AdComponentFrameLayout this$0;
