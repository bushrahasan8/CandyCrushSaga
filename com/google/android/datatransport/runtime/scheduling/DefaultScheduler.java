...
/* loaded from: DefaultScheduler.class */
public class DefaultScheduler implements Scheduler {
    ...
    public /* synthetic */ void lambda$schedule$1(final TransportContext transportContext, TransportScheduleCallback transportScheduleCallback, EventInternal eventInternal) {
        try {
            ...
            if (transportBackend == null) {
                ...
                this.guard.runCriticalSection(new SynchronizationGuard.CriticalSection(this, transportContext, decorate) { // from class: com.google.android.datatransport.runtime.scheduling.DefaultScheduler$$ExternalSyntheticLambda1
    ...
    public void schedule(final TransportContext transportContext, final EventInternal eventInternal, final TransportScheduleCallback transportScheduleCallback) {
        this.executor.execute(new Runnable(this, transportContext, transportScheduleCallback, eventInternal) { // from class: com.google.android.datatransport.runtime.scheduling.DefaultScheduler$$ExternalSyntheticLambda0
            public final DefaultScheduler f$0;
            public final TransportContext f$1;
