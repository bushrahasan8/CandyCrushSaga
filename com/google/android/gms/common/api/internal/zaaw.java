...
public final class zaaw implements zabf {
        ...
        if (clientSettings == null) {
            ...
            for (Api api : zad.keySet()) {
                ...
                if (!zabiVar.zab.containsKey(api.zab())) {
                    hashSet2.addAll(((com.google.android.gms.common.internal.zab) zad.get(api)).zaa);
                }
            }
            hashSet = hashSet2;
        }
    ...
    /* JADX WARN: Type inference failed for: r1v20, types: [com.google.android.gms.common.api.Api$Client, com.google.android.gms.signin.zae] */
    @Override // com.google.android.gms.common.api.internal.zabf
