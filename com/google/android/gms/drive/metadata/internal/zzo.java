...
public final class zzo extends zzl<DriveId> implements SearchableCollectionMetadataField<DriveId> {
    ...
    public final Collection<DriveId> zzc(DataHolder dataHolder, int i, int i2) {
                ...
                synchronized (dataHolder) {
                    ...
                    if (dataHolder2 != null) {
                        try {
                            ...
                            ArrayList<? extends Parcelable> arrayList2 = new ArrayList<>(count);
                            HashMap hashMap = new HashMap(count);
                            for (int i3 = 0; i3 < count; i3++) {
                                int windowIndex = dataHolder.getWindowIndex(i3);
                                ParentDriveIdSet parentDriveIdSet = new ParentDriveIdSet();
                                arrayList2.add(parentDriveIdSet);
                            ...
                            dataHolder.getMetadata().putParcelableArrayList("parentsExtra", arrayList2);
                        } finally {
                            dataHolder2.close();
        ...
        ParentDriveIdSet parentDriveIdSet2 = (ParentDriveIdSet) arrayList.get(i);
