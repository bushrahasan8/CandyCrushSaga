...
final class zzajr implements zzadu {
    ...
    public final zzads zzg(long j) {
        ...
        j5 = this.zza.zzf;
        long longValue = multiply.divide(BigInteger.valueOf(j5)).longValue();
        zzajs zzajsVar3 = this.zza;
        j6 = zzajsVar3.zzb;
        j7 = zzajsVar3.zzc;
        zzadv zzadvVar = new zzadv(j, Math.max(j6, Math.min((j2 + longValue) - 30000, j7 - 1)));
