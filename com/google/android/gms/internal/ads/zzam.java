...
public final class zzam {
    ...
    private zzam(zzak zzakVar) {
        ...
        this.zzD = zzak.zzi(zzakVar) == -1 ? 0 : zzak.zzi(zzakVar);
    ...
    public final int hashCode() {
        ...
        if (i == 0) {
            ...
            int hashCode5 = zzbyVar == null ? 0 : zzbyVar.hashCode();
            ...
            i2 = ((((((((((((((((((((((((((((((((((((((((((((((((((((((hashCode + IronSourceError.ERROR_NON_EXISTENT_INSTANCE) * 31) + hashCode2) * 31) + hashCode3) * 31) + i4) * 31) + i5) * 31) + i6) * 31) + i7) * 31) + hashCode4) * 31) + hashCode5) * 31) + hashCode6) * 31) + i3) * 31) + this.zzn) * 31) + ((int) this.zzq)) * 31) + this.zzr) * 31) + this.zzs) * 31) + Float.floatToIntBits(this.zzt)) * 31) + this.zzu) * 31) + Float.floatToIntBits(this.zzv)) * 31) + this.zzx) * 31) + this.zzz) * 31) + this.zzA) * 31) + this.zzB) * 31) + this.zzC) * 31) + this.zzD) * 31) + this.zzE) * 31) - 1) * 31) - 1) * 31) + this.zzG;
            this.zzao = i2;
        }
        return i2;
    }
