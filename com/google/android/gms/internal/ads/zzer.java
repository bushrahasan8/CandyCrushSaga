...
public final class zzer implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public final void zzb(int i) throws zzet {
        ...
        zzeu.zzb(z, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr2[0]), eGLConfigArr[0]));
