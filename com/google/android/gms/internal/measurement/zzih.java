...
/* loaded from: zzih.class */
final class zzih extends zzid<Boolean> implements zzkc<Boolean>, zzls, RandomAccess {
    ...
    private zzih(boolean[] zArr, int i, boolean z) {
        super(z);
        this.zzb = zArr;
        this.zzc = i;
    }
    ...
    public final /* synthetic */ zzkc<Boolean> zza(int i) {
        if (i >= this.zzc) {
            return new zzih(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
