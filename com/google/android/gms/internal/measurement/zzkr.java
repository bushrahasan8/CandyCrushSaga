...
/* loaded from: zzkr.class */
public final class zzkr extends zzid<Long> implements zzjz, zzls, RandomAccess {
    ...
    private zzkr(long[] jArr, int i, boolean z) {
        super(z);
        this.zzb = jArr;
        this.zzc = i;
    }
    ...
    public final zzjz zza(int i) {
        if (i >= this.zzc) {
            return new zzkr(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
