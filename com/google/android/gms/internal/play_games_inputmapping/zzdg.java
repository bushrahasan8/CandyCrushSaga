...
public enum zzdg {
    ...
    static {
        ...
        for (zzdg zzdgVar : values()) {
            if (hashMap.put(Character.valueOf(zzdgVar.zzG), zzdgVar) != null) {
                throw new IllegalStateException("duplicate format character: ".concat(String.valueOf(zzdgVar)));
            }
        }
    ...
    public static final zzdg zza(char c) {
        return (zzdg) zzF.get(Character.valueOf(c));
    }
