...
public final class zzn extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = a.g, id = 9)
    ...
    @SafeParcelable.Field(defaultValue = a.g, id = 16)
    ...
    @SafeParcelable.Field(defaultValue = "", id = Sdk$SDKMetric.SDKMetricType.VIEW_NOT_VISIBLE_ON_PLAY_VALUE)
    public final String zzt;

    @SafeParcelable.Field(defaultValue = "", id = Sdk$SDKMetric.SDKMetricType.MRAID_DOWNLOAD_JS_RETRY_SUCCESS_VALUE)
    public final String zzu;

    @SafeParcelable.Field(id = Sdk$SDKMetric.SDKMetricType.OMSDK_DOWNLOAD_JS_RETRY_SUCCESS_VALUE)
    public final String zzv;

    @SafeParcelable.Field(defaultValue = "false", id = Sdk$SDKMetric.SDKMetricType.PRIVACY_URL_OPENED_VALUE)
    ...
    public zzn(String str, String str2, String str3, long j, String str4, long j2, long j3, String str5, boolean z, boolean z2, String str6, long j4, long j5, int i, boolean z3, boolean z4, String str7, Boolean bool, long j6, List<String> list, String str8, String str9, String str10, String str11, boolean z5, long j7, int i2, String str12, int i3, long j8, String str13, String str14) {
