...
/* loaded from: InsetDialogOnTouchListener.class */
public class InsetDialogOnTouchListener implements View.OnTouchListener {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (new RectF(left, this.topInset + findViewById.getTop(), width + left, findViewById.getHeight() + r0).contains(motionEvent.getX(), motionEvent.getY())) {
            return false;
        }
