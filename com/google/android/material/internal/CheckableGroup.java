...
/* loaded from: CheckableGroup.class */
public class CheckableGroup {
    ...
    /* loaded from: CheckableGroup$OnCheckedStateChangeListener.class */
    ...
    public void addCheckable(MaterialCheckable materialCheckable) {
        ...
        materialCheckable.setInternalOnCheckedChangeListener(new MaterialCheckable.OnCheckedChangeListener(this) { // from class: com.google.android.material.internal.CheckableGroup.1
            ...
            public void onCheckedChanged(MaterialCheckable materialCheckable2, boolean z) {
                ...
                } else if (!this.this$0.checkInternal(materialCheckable2)) {
                    return;
                }
    ...
    public int getSingleCheckedId() {
        return (!this.singleSelection || this.checkedIds.isEmpty()) ? -1 : ((Integer) this.checkedIds.iterator().next()).intValue();
    }
