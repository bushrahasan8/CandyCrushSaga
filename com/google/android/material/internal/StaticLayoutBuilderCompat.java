...
/* loaded from: StaticLayoutBuilderCompat.class */
final class StaticLayoutBuilderCompat {
    ...
    /* loaded from: StaticLayoutBuilderCompat$StaticLayoutBuilderCompatException.class */
    static abstract class StaticLayoutBuilderCompatException extends Exception {
    }
    ...
    public StaticLayout build() {
        ...
        int min = Math.min(charSequence2.length(), this.end);
        this.end = min;
        if (this.isRtl && this.maxLines == 1) {
            this.alignment = Layout.Alignment.ALIGN_OPPOSITE;
        }
        StaticLayout.Builder obtain = StaticLayout.Builder.obtain(charSequence2, this.start, min, this.paint, max);
