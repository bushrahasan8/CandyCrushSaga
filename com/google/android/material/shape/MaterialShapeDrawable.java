...
/* loaded from: MaterialShapeDrawable.class */
public class MaterialShapeDrawable extends Drawable implements Shapeable {
    ...
    /* loaded from: MaterialShapeDrawable$MaterialShapeDrawableState.class */
    ...
    private void calculateStrokePath() {
        ShapeAppearanceModel withTransformedCornerSizes = getShapeAppearanceModel().withTransformedCornerSizes(new ShapeAppearanceModel.CornerSizeUnaryOperator(this, -getStrokeInsetLength()) { // from class: com.google.android.material.shape.MaterialShapeDrawable.2
            ...
            {
                this.this$0 = this;
                this.val$strokeInsetLength = r5;
            }

            @Override // com.google.android.material.shape.ShapeAppearanceModel.CornerSizeUnaryOperator
            public CornerSize apply(CornerSize cornerSize) {
                if (!(cornerSize instanceof RelativeCornerSize)) {
                    cornerSize = new AdjustedCornerSize(this.val$strokeInsetLength, cornerSize);
                }
                return cornerSize;
            }
        });
    ...
    public int compositeElevationOverlayIfNeeded(int i) {
        ...
        if (elevationOverlayProvider != null) {
            i2 = elevationOverlayProvider.compositeOverlayIfNeeded(i, z + parentAbsoluteElevation);
        }
        return i2;
    }
