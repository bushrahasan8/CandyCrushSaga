...
/* loaded from: CustomThreadFactory.class */
public class CustomThreadFactory implements ThreadFactory {
    ...
    public Thread newThread(final Runnable runnable) {
        Thread newThread = DEFAULT.newThread(new Runnable(this, runnable) { // from class: com.google.firebase.concurrent.CustomThreadFactory$$ExternalSyntheticLambda0
