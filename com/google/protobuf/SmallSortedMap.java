...
/* loaded from: SmallSortedMap.class */
public class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    /* loaded from: SmallSortedMap$DescendingEntryIterator.class */
    private class DescendingEntryIterator implements Iterator<Map.Entry<K, V>> {
        ...
        private DescendingEntryIterator(SmallSortedMap smallSortedMap) {
            ...
            this.pos = smallSortedMap.entryList.size();
        }
        ...
        public boolean hasNext() {
            int i = this.pos;
            return (i > 0 && i <= this.this$0.entryList.size()) || getOverflowIterator().hasNext();
        }
        ...
        public Map.Entry<K, V> next() {
            ...
            List list = this.this$0.entryList;
            int i = this.pos - 1;
            this.pos = i;
    ...
    /* loaded from: SmallSortedMap$DescendingEntrySet.class */
    ...
    /* loaded from: SmallSortedMap$EmptySet.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: SmallSortedMap$Entry.class */
    ...
    /* loaded from: SmallSortedMap$EntryIterator.class */
    private class EntryIterator implements Iterator<Map.Entry<K, V>> {
        ...
        public boolean hasNext() {
            ...
            if (this.pos + 1 >= this.this$0.entryList.size()) {
                z = !this.this$0.overflowEntries.isEmpty() && getOverflowIterator().hasNext();
            }
            return z;
        }
        ...
        public Map.Entry<K, V> next() {
            ...
            int i = this.pos + 1;
            this.pos = i;
            return i < this.this$0.entryList.size() ? (Map.Entry) this.this$0.entryList.get(this.pos) : getOverflowIterator().next();
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: SmallSortedMap$EntrySet.class */
