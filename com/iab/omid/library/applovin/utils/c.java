...
public class c {
    ...
    public static void a(JSONObject jSONObject, a.C0011a c0011a) {
        com.iab.omid.library.applovin.internal.e a2 = c0011a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0011a.b().iterator();
        while (it.hasNext()) {
