...
public class a {
    ...
    private final HashMap<View, C0014a> b = new HashMap<>();
    ...
    public static class C0014a {
        ...
        public C0014a(e eVar, String str) {
            this.a = eVar;
            a(str);
        }
    ...
    private void a(e eVar, com.iab.omid.library.ironsrc.adsession.a aVar) {
        ...
        C0014a c0014a = this.b.get(view);
        if (c0014a != null) {
            c0014a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0014a(eVar, aVar.getAdSessionId()));
        }
    }
