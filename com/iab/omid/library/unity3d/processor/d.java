...
public class d implements a {
    ...
    private void a(ViewGroup viewGroup, JSONObject jSONObject, a.InterfaceC0016a interfaceC0016a, boolean z) {
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            interfaceC0016a.a(viewGroup.getChildAt(i), this, jSONObject, z);
        }
    }

    @TargetApi(21)
    private void b(ViewGroup viewGroup, JSONObject jSONObject, a.InterfaceC0016a interfaceC0016a, boolean z) {
        ...
        while (it.hasNext()) {
            ...
            while (it2.hasNext()) {
                interfaceC0016a.a((View) it2.next(), this, jSONObject, z);
            }
        }
    }
    ...
    public void a(View view, JSONObject jSONObject, a.InterfaceC0016a interfaceC0016a, boolean z, boolean z2) {
        if (view instanceof ViewGroup) {
            ...
            if (z) {
                b(viewGroup, jSONObject, interfaceC0016a, z2);
            } else {
                a(viewGroup, jSONObject, interfaceC0016a, z2);
            }
        }
    }
}
