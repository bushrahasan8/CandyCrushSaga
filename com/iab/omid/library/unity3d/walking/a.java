...
public class a {
    ...
    private final HashMap<View, C0018a> b = new HashMap<>();
    ...
    public static class C0018a {
        ...
        public C0018a(e eVar, String str) {
            this.a = eVar;
            a(str);
        }
    ...
    private void a(e eVar, com.iab.omid.library.unity3d.adsession.a aVar) {
        ...
        C0018a c0018a = this.b.get(view);
        if (c0018a != null) {
            c0018a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0018a(eVar, aVar.getAdSessionId()));
        }
    }
