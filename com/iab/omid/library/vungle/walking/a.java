...
public class a {
    ...
    private final HashMap<View, C0022a> b = new HashMap<>();
    ...
    public static class C0022a {
        ...
        public C0022a(e eVar, String str) {
            this.a = eVar;
            a(str);
        }
    ...
    private void a(e eVar, com.iab.omid.library.vungle.adsession.a aVar) {
        ...
        C0022a c0022a = this.b.get(view);
        if (c0022a != null) {
            c0022a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0022a(eVar, aVar.getAdSessionId()));
        }
    }
