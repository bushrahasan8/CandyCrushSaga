...
public class a0 {
    ...
    private void d() {
        ...
        this.o = hashMap;
        hashMap.put(y.INIT_STARTED, new a(IronSourceConstants.NT_MANAGER_INIT_STARTED, -1));
        ...
        this.o.put(y.LOAD_AD, new a(IronSourceConstants.NT_LOAD, IronSourceConstants.NT_INSTANCE_LOAD));
        this.o.put(y.LOAD_AD_SUCCESS, new a(IronSourceConstants.NT_CALLBACK_LOAD_SUCCESS, IronSourceConstants.NT_INSTANCE_LOAD_SUCCESS));
    ...
    void a() {
        HashMap hashMap = new HashMap();
        this.n = hashMap;
        hashMap.put(y.INIT_STARTED, new a(IronSourceConstants.BN_MANAGER_INIT_STARTED, -1));
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void a(y yVar, Map map, long j) {
        int a2 = a(yVar);
        if (-1 == a2) {
            return;
        }
        ...
        z zVar = this.d;
        if (zVar != null) {
            hashMap.putAll(zVar.a(yVar));
        }
        if (map != null && !map.isEmpty()) {
            hashMap.putAll(map);
        }
        this.e.a(new l4(a2, j, new JSONObject(hashMap)));
    }
    ...
    void c() {
        HashMap hashMap = new HashMap();
        this.l = hashMap;
        hashMap.put(y.INIT_STARTED, new a(IronSourceConstants.IS_MANAGER_INIT_STARTED, -1));
    ...
    void e() {
        HashMap hashMap = new HashMap();
        this.m = hashMap;
        hashMap.put(y.INIT_STARTED, new a(IronSourceConstants.RV_MANAGER_INIT_STARTED, -1));
