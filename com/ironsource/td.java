...
public class td {
    ...
    public static final ArrayList<String> y1 = new ArrayList<>(Arrays.asList(q1, a, b, "appKey", d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, "bat", y, z, A, B, C, D, E, V, "consent", h, g, M, "auid", G, "asid"));
    public static final HashMap<String, String> z1 = new a();

    /* loaded from: td$a.class */
