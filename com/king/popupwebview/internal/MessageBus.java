...
public final class MessageBus {
    ...
    public final class JavascriptMessageBusInterface {
        ...
        /* renamed from: com.king.popupwebview.internal.MessageBus$JavascriptMessageBusInterface$1, reason: invalid class name */
        ...
        class AnonymousClass1 implements Runnable {
            ...
            public void run() {
                ...
                try {
                    iMessageListener.onMessageReceived(this.val$msgName, this.val$msgPayload, this.val$responseCallbackId >= 0 ? new IResponder(this) { // from class: com.king.popupwebview.internal.MessageBus.JavascriptMessageBusInterface.1.1
        ...
        public void sendMessageResponse(int i, int i2, String str) {
            this.this$0.popup.getActivityWrapper().runOnUIThread(new Runnable(this, i, i2, str) { // from class: com.king.popupwebview.internal.MessageBus.JavascriptMessageBusInterface.2
                final JavascriptMessageBusInterface this$1;
    ...
    public void postMessage(String str, String str2, IResponseCallback iResponseCallback) {
        ...
        this.popup.executeJavascript(String.format(Locale.ROOT, JAVASCRIPT_ON_MESSAGE_RECEIVED_FORMAT, escapeJavascriptString(str), escapeJavascriptString(str2), Integer.valueOf(i2)), new ValueCallback(this, i2) { // from class: com.king.popupwebview.internal.MessageBus.1
            final MessageBus this$0;
