...
public class Popup implements IPopup {
    ...
    /* loaded from: Popup$CustomWebChromeClient.class */
    private final class CustomWebChromeClient extends WebChromeClient {
        final Popup this$0;

        private CustomWebChromeClient(Popup popup) {
            this.this$0 = popup;
        }
    ...
    private final class CustomWebViewClient extends WebViewClient {
        ...
        public void onPageFinished(WebView webView, String str) {
            if (this.this$0.pageState == null || this.this$0.pageState == PageState.BLANK) {
                ...
                this.this$0.messageBus.firePageLoaded(this.this$0.loadingTargetUrl);
        ...
        public void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
            if (webView == this.this$0.webView) {
                notifyError(webResourceError.getDescription().toString());
            }
        }
    ...
    public void initializeWebResources(boolean z) {
        this.activityWrapper.runOnUIThread(new Runnable(this, z) { // from class: com.king.usdk.popupwebview.internal.Popup.1
            final Popup this$0;
            ...
            public void run() {
                if (this.this$0.popupDialog == null) {
                    ...
                    if (this.this$0.webView != null) {
                        ...
                        this.this$0.webView.setWebChromeClient(new CustomWebChromeClient());
    ...
    */
    private static java.lang.String normalizeUrl(java.lang.String r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.king.usdk.popupwebview.internal.Popup.normalizeUrl(java.lang.String):java.lang.String");
    }
    ...
    public void clearCache() {
        this.activityWrapper.runOnUIThread(new Runnable(this) { // from class: com.king.usdk.popupwebview.internal.Popup.6
            final Popup this$0;
    ...
    public void clearWebView() {
        ...
        this.activityWrapper.runOnUIThread(new Runnable(this) { // from class: com.king.usdk.popupwebview.internal.Popup.7
            final Popup this$0;
    ...
    public void executeJavascriptOnUIThread(String str, ValueCallback<String> valueCallback) {
        this.activityWrapper.runOnUIThread(new Runnable(this, str, valueCallback) { // from class: com.king.usdk.popupwebview.internal.Popup.3
            final Popup this$0;
    ...
    @Override // com.king.usdk.popupwebview.IPopup
    public void hide() {
        this.activityWrapper.runOnUIThread(new Runnable(this) { // from class: com.king.usdk.popupwebview.internal.Popup.5
            final Popup this$0;
    ...
    public void loadPage(String str, boolean z) {
        ...
        if (normalizeUrl == null) {
            ...
            this.activityWrapper.runOnUIThread(new Runnable(this, z, normalizeUrl) { // from class: com.king.usdk.popupwebview.internal.Popup.8
                final Popup this$0;
    ...
    public void postMessage(String str, String str2, IResponseCallback iResponseCallback) {
        this.activityWrapper.runOnUIThread(new Runnable(this, str, str2, iResponseCallback) { // from class: com.king.usdk.popupwebview.internal.Popup.10
            final Popup this$0;
    ...
    public void recycleWebResources() {
        this.activityWrapper.runOnUIThread(new Runnable(this) { // from class: com.king.usdk.popupwebview.internal.Popup.2
            final Popup this$0;
    ...
    @Override // com.king.usdk.popupwebview.IPopup
    public void show() {
        this.activityWrapper.runOnUIThread(new Runnable(this) { // from class: com.king.usdk.popupwebview.internal.Popup.4
            final Popup this$0;
    ...
    public void unloadPage() {
        this.activityWrapper.runOnUIThread(new Runnable(this) { // from class: com.king.usdk.popupwebview.internal.Popup.9
            final Popup this$0;
