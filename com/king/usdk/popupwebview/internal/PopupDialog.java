...
public final class PopupDialog {
        ...
        public boolean dispatchKeyEvent(KeyEvent keyEvent) {
            ...
            if (this.this$0.decorView == this && keyEvent.getKeyCode() == 4 && (keyDispatcherState = getKeyDispatcherState()) != null) {
                ...
                if (keyEvent.getAction() == 1 && keyDispatcherState.isTracking(keyEvent) && !keyEvent.isCanceled()) {
                    ...
                    this.this$0.openedPopup.backButtonPressed();
                    return true;
                }
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setFullScreenMode(View view, boolean z) {
        WindowInsetsController windowInsetsController;
        ...
        windowInsetsController = view.getWindowInsetsController();
        WindowInsetsControllerCompat$Impl30$.ExternalSyntheticApiModelOutline0.m(windowInsetsController, 2);
        windowInsetsController2 = view.getWindowInsetsController();
        WindowInsetsControllerCompat$Impl30$.ExternalSyntheticApiModelOutline3.m(windowInsetsController2, WindowInsetsCompat$TypeImpl30$.ExternalSyntheticApiModelOutline0.m());
        if (z) {
            windowInsetsController4 = view.getWindowInsetsController();
            windowInsetsController4.show(WindowInsetsCompat$TypeImpl30$.ExternalSyntheticApiModelOutline1.m());
        } else {
            windowInsetsController3 = view.getWindowInsetsController();
            WindowInsetsControllerCompat$Impl30$.ExternalSyntheticApiModelOutline3.m(windowInsetsController3, WindowInsetsCompat$TypeImpl30$.ExternalSyntheticApiModelOutline1.m());
        }
    }
    ...
    public void open(Popup popup) {
        ...
        if (!this.forceFullscreen) {
            z = checkImmersiveMode(activityDecorView);
        }
        if (z) {
            setFullScreenMode(this.contentView, false);
            processDisplayCutout(context, layoutParams);
            this.contentView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener(this) { // from class: com.king.usdk.popupwebview.internal.PopupDialog.1
                ...
                public void onGlobalLayout() {
                    ...
                    if (i > height * 0.33d) {
                        ...
                        layoutParams2.height = height;
                        PopupDialog popupDialog2 = this.this$0;
