...
/* loaded from: SendDiagnosticEvent.class */
public interface SendDiagnosticEvent {
    ...
    /* loaded from: SendDiagnosticEvent$Companion.class */
    ...
    /* loaded from: SendDiagnosticEvent$DefaultImpls.class */
    ...
    void invoke(String str, Double d, Map<String, String> map, Map<String, Integer> map2, AdObject adObject);
}
