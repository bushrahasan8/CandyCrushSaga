...
/* loaded from: ScarAdHandlerBase.class */
public abstract class ScarAdHandlerBase implements IScarAdListenerWrapper {
    ...
    public void onAdOpened() {
        ...
        this._eventSubject.subscribe(new IEventListener<GMAEvent>(this) { // from class: com.unity3d.services.ads.gmascar.handlers.ScarAdHandlerBase.1
            final ScarAdHandlerBase this$0;
            ...
            public void onNextEvent(GMAEvent gMAEvent) {
                this.this$0._gmaEventSender.send(gMAEvent, new Object[0]);
            }
        });
    }
}
