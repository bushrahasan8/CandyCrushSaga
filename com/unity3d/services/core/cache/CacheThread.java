...
public class CacheThread extends Thread {
    ...
    public static void download(String str, String str2, HashMap<String, List<String>> hashMap, boolean z, IEventSender iEventSender) {
