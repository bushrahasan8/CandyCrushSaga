...
/* loaded from: Jdk8WithJettyBootPlatform.class */
public final class Jdk8WithJettyBootPlatform extends Platform {
    ...
    /* loaded from: Jdk8WithJettyBootPlatform$AlpnProvider.class */
    private static final class AlpnProvider implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] objArr) {
            ...
            if (Intrinsics.areEqual(name, "protocols") && objArr2.length == 0) {
                return this.protocols;
            }
            if ((Intrinsics.areEqual(name, "selectProtocol") || Intrinsics.areEqual(name, "select")) && Intrinsics.areEqual(String.class, returnType) && objArr2.length == 1) {
            ...
            if ((!Intrinsics.areEqual(name, "protocolSelected") && !Intrinsics.areEqual(name, "selected")) || objArr2.length != 1) {
    ...
    /* loaded from: Jdk8WithJettyBootPlatform$Companion.class */
