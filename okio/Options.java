...
public final class Options extends AbstractList implements RandomAccess {
    ...
    /* loaded from: Options$Companion.class */
        ...
        private final void buildTrieRecursive(long j, Buffer buffer, int i, List list, int i2, int i3, List list2) {
            ...
            if (i16 < i3) {
                while (true) {
                    int i19 = i16 + 1;
                    i17 = i18;
                    if (((ByteString) list.get(i16 - 1)).getByte(i7) != ((ByteString) list.get(i16)).getByte(i7)) {
                        i17 = i18 + 1;
                    }
                    if (i19 >= i3) {
                        break;
            ...
            if (i4 < i3) {
                ...
                while (true) {
                    int i21 = i20;
                    int i22 = i21 + 1;
                    byte b = ((ByteString) list.get(i21)).getByte(i7);
                    if (i21 == i4 || b != ((ByteString) list.get(i21 - 1)).getByte(i7)) {
            ...
            while (true) {
                ...
                byte b2 = ((ByteString) list.get(i23)).getByte(i7);
                int i24 = i23 + 1;
                if (i24 < i3) {
                    int i25 = i24;
                    while (true) {
                        i4 = i25;
                        int i26 = i4 + 1;
                        if (b2 != ((ByteString) list.get(i4)).getByte(i7)) {
                            break;
                        } else if (i26 >= i3) {
                            break;
                        } else {
                ...
                i4 = i3;
                if (i24 == i4 && i7 + 1 == ((ByteString) list.get(i23)).size()) {
                    buffer.writeInt(((Number) list2.get(i23)).intValue());
                } else {
